...
- **project_dir** (optional, default: "output/planning/{project_name}"): The base directory where all project files will be stored
...
## Directory Structure
- output/planning/template-feature/
...
## Next Steps
1. Review the detailed design document at output/planning/template-feature/design/detailed-design.md
2. Check the implementation plan and checklist at output/planning/template-feature/implementation/plan.md
